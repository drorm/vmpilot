...
def _modify_state_messages(state: AgentState, provider: APIProvider):
    ...
    logger.debug(f"Current provider: {provider}")  # Log the passed provider
...
async def create_agent(
    ...
    # Create a partial function that bakes in the provider
    state_modifier_with_provider = functools.partial(
        _modify_state_messages, provider=provider
    )
    ...
    agent = create_react_agent(
        llm,
        tools,
        state_modifier=state_modifier_with_provider,
