...
class ShellTool(BaseTool):
    ...
    name: str = "shell"
    description: str = "Execute bash commands in the system. Input should be a single command string."
    ...
    async def _arun(self, commands: Union[str, List[str]], run_manager: Optional[CallbackManagerForToolRun] = None) -> str:
