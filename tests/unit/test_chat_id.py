...
class TestChatID:
    ...
    def test_extract_existing_chat_id_from_messages(self, pipeline, mock_callback):
        ...
        messages = [
            {"role": "system", "content": "System prompt"},
            {"role": "user", "content": "User message"},
            {"role": "assistant", "content": f"Chat_id:{test_chat_id}\n\nAssistant response"}
        ]
    ...
    def test_non_string_content(self, pipeline, mock_callback):
        ...
        messages = [
            {"role": "system", "content": "System prompt"},
            {"role": "user", "content": "User message"},
            {"role": "assistant", "content": [{"type": "text", "text": "Chat id:abc12345\n\nResponse"}]}
        ]
    ...
    def test_inlet_chat_id_priority(self, pipeline, mock_callback):
        ...
        messages = [
            {"role": "system", "content": "System prompt"},
            {"role": "user", "content": "User message"},
            {"role": "assistant", "content": "Chat id:extracted456\n\nAssistant response"}
        ]
    ...
    def test_malformed_chat_id_line(self, pipeline, mock_callback):
        ...
        messages = [
            {"role": "system", "content": "System prompt"},
            {"role": "user", "content": "User message"},
            {"role": "assistant", "content": "ChatId without proper formatting\n\nAssistant response"}
        ]
