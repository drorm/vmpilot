...
class GitTracker:
    ...
    def stash_changes(self, message: str = "User changes before LLM request") -> bool:
        ...
        try:
            ...
            logger.debug(f"Stashed changes: {result.stdout.strip()}")
            return True
    ...
    def pop_stash(self, stash_index: int = 0) -> bool:
        ...
        try:
            ...
            logger.debug(f"Popped stash: {result.stdout.strip()}")
            return True
        except subprocess.CalledProcessError as e:
